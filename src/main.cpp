...
int WINAPI wWinMain(_In_ HINSTANCE hInstance, _In_opt_ HINSTANCE hPrevInstance, _In_ PWSTR pCmdLine, _In_ int nCmdShow)
{
	...
	//std::array<ComPtr<ID3D11Texture2D>, 8> NvdecBuffers;
	...
	/*for (auto& buffer : NvdecBuffers) {
		D3D11Device->CreateTexture2D(&custommainBufferDesc, nullptr, buffer.GetAddressOf());
	}*/
